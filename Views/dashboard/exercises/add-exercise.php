    ...
    <div>
        <form class="add-exercise row" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-6 mb-1">
                ...
                required>
                <div class="form-text text-danger fs-7"><?= $error['title'] ?? '' ?></div>
            </div>
            ...
            <div class="col-12 mb-1">
                ...
                <div class="form-text text-danger fs-7"><?= $error['intro'] ?? '' ?></div>
            </div>
            ...
            <div class="col-12 mb-1">
                ...
                <div class="form-text text-danger fs-7"><?= $error['position'] ?? '' ?></div>
            </div>
            ...
            <div class="col-12 mb-1">
                ...
                <div class="form-text text-danger fs-7"><?= $error['movement'] ?? '' ?></div>
            </div>
            ...
            <div class="col-12 mb-1">
                ...
                <div class="form-text text-danger fs-7"><?= $error['targeted_muscles'] ?? '' ?></div>
            </div>
            ...
            <div class="col-5 mb-3">
                ...
                <div class="form-text text-danger fs-7"><?= $error['body_part_id'] ?? '' ?></div>
            </div>
