...
<div class="container">
            ...
            <form action="" method="GET">
                ...
                <select class="form-control" name="category_article_id" id="category_article_id">
                    ...
                    <?php foreach ($categories_articles as $category_article) : ?>
                        <option value="<?= $category_article->category_article_id ?>">
    ...
    <div class="my-3">
                            <a href="http://localhost:8001/?page=articless/add-article" class="exercise-title btn btn-add">Ajouter un article<i class="fas fa-plus ms-2"></i></a>
                        </div>
