    ...
    <header>
        ...
        <nav class="mobile d-md-none ">
            <div class="container-fluid d-flex justify-content-between mt-2">
                <div class="col-9 "><img src="/public/assets/img/logo/FIT.HELP-name.png" alt="logo fit" width="102"
                        height="30">
                </div>
                <div class="col-1"><img src="/public/assets/img/icons8-utilisateur-50.png" alt="photo de profil"
                        width="30" height="30">
                </div>
                <div class="col-1">
            ...
            <div class="container-fluid row  me-1">
                ...
                <div class="collapse navbar-collapse col-8 d-flex justify-content-between" id="navbarSupportedContent">
                    <ul class="navbar-nav vw-100 justify-content-between">
                        ...
                        <li>
                            <img class="mt-1" src="/public/assets/img/icons8-utilisateur-50.png" alt="photo de profil"
                                width="40" height="40">
                        </li>
                    </ul>
                </div>
        ...
        <nav class="desktop navbar navbar-expand d-flex d-none d-lg-block">
            <div class="container-fluid row">
                <div class="col-4">
                    <img src="/public/assets/img/logo/FIT.HELP-name.png" alt="logo" class="logo_desktop" width="170"
                        height="50">
                </div>
...
<script src="/public/assets/js/js/bootstrap.bundle.min.js"></script>
</body>
