...
<div class="container my-4">
    ...
    <article class="exercise-content mx-auto" style="max-width: 800px;">
        ...
        <section class="exercise-conclusion">
            ...
            <p class="unicode"><?= $exercise->targeted_muscles ?></p>
        </section>
    </article>
    ...
    <?php if ($user->role == 1) : ?>
        <div class="d-flex justify-content-around my-4">
            <a href="?page=exercises/update-exercise&exercise_id=<?= $exercise->exercise_id ?>" class="btn btn-warning">Modifier</a>
            <form action="?page=exercises/delete-exercise" method="POST">
